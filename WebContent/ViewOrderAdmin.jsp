					...
					<table border="1">
						...
						<s:forEach items="${OrderMaster}" var="OrderMaster">
							<tr>
								...
								<s:if test="${OrderMaster.orderStatus ne 'Dispatched'}">
								<td><a href="/ShoppingCart/app/order/dispatchOrder?orderId=${OrderMaster.orderId}">Dispatch</a> </td>
								</s:if>
							</tr>
						</s:forEach>
						</table>
